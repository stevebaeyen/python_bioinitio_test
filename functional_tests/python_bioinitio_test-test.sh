...
this_program_name="python_bioinitio_test-test.sh"
...
${this_program_name}: run integration/regression tests for python_bioinitio_test 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/python_bioinitio_test -d data/tests
